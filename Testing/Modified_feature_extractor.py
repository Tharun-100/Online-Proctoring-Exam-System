    ...
    def _extract_face_features(self, rgb_image: np.ndarray, width: int, height: int) -> Dict:
        ...
        if face_results.detections:
            ...
            if mesh_results.face_landmarks:
                ...
                features['pupil_left_x'] = float(left_eye_center[0])
                features['pupil_left_y'] = float(left_eye_center[1])
                ...
                features['pupil_right_x'] = float(right_eye_center[0])
                features['pupil_right_y'] = float(right_eye_center[1])
