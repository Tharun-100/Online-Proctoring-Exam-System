...
class FeatureExtractor:
    ...
    def _get_default_features(self) -> Dict:
        ...
        return {
            'number_of_people': 0,
            'face_conf': 0,
            'head_pose': 0, # by default, assume on-screen
            'head_pitch': 0.0,
            'head_yaw': 0.0,
            'head_roll': 0.0,
            'phone_present': 0,
    ...
    def _extract_head_pose(self, rgb_image: np.ndarray,  width: int, height: int) -> Dict:
        ...
        features = {"head_pitch":0.0,"head_yaw":0.0,"head_roll":0.0,"head_pose":0} #,"nose_2d":(0,0),"nose_3d":(0,0,0),"rvec": (0,0,0),"tvec": (0,0,0),"camera_matrix": camera_matrix,"dist_coeffs": dist_coeffs}
